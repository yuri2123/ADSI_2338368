...
<html lang="en">
  <head>
    ...
    <title>Hoteleria Y Turismo Popayan 2022</title>
  </head>
  <body>
    <h1>Bienvenidos Aprendices ADSI 2338368</h1>
    <!-- Barra de navegaciob del administrador -->
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/logo.png" width="90" height="90" alt= "Hotel y Restaurante"></a>
